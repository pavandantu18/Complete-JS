...
// console.log(fruits["apple"]); ->  Output: undefined, because there is no key named apple
...
//? 1: for of loop , also known as iterable -> gives values
...
//? 1: push(): Method that adds one or more elements to the end and returns the new length of the array.
console.log(fruits.push("guava"));
console.log(fruits);
// The push() method returns the new length.
//? 2: pop(): Method that removes the last element from an array and returns removed element.
...
const result2 = numbers1.indexOf(6);
console.log(result2);
const result1 = numbers1.lastIndexOf(6);
console.log(result1);
